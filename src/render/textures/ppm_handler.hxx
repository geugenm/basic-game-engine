...
public:
    ...
    PpmHandler(const PpmHandler& other)
        : File(other), texture_(std::make_unique<Texture>(other.get_texture()))
    {
    }
    ...
    void load() override
    {
        ...
        {
            throw std::runtime_error("Failed to load PPM file '" + get_path().string() +
                                     "': " + e.what());
        }
    }
    ...
    void save() override
    {
        ...
        {
            throw std::runtime_error("Failed to save PPM file '" + get_path().string() +
                                     "': " + e.what());
        }
    }
