...
if (CLANG_TIDY)
  add_custom_target(tidy
          ...
          COMMAND ${CLANG_TIDY} ${PROJECT_SOURCE_DIR}/src/*.cxx ${PROJECT_SOURCE_DIR}/include/*.hxx ${PROJECT_SOURCE_DIR}/test/*.cxx
          COMMAND ${CLANG_TIDY} ${PROJECT_SOURCE_DIR}/src/*.c ${PROJECT_SOURCE_DIR}/include/*.h ${PROJECT_SOURCE_DIR}/test/*.c
