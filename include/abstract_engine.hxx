...
public:
    ...
    static Instance &instance()
    {
        ...
        std::call_once(init_flag, [&]() { instance_.reset(static_cast<Derived *>(create_instance())); });
        return *instance_;
    }
...
template <typename Derived> std::unique_ptr<Instance<Derived>> Instance<Derived>::instance_ = nullptr;
} // namespace Engine
